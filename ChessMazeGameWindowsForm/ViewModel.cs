...
namespace ChessMazeGameWindowsForm
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        // only Diffrenace between the ViewModel for WindowsForm and Window Presentation Foundation!
        public void NavigateToMainMenu()
        {
            ...
            if (mainForm != null)
            {
                var gameForm = mainForm.Controls["gameForm"];
                var mainMenu = mainForm.Controls["mainMenu"];

                if (gameForm != null && mainMenu != null)
                {
                ...
                {
                    MessageBox.Show("Unable to navigate to the main menu. Required controls are missing.");
                }
            }
            else
            {
                MessageBox.Show("Main form is not available.");
            }
        }
